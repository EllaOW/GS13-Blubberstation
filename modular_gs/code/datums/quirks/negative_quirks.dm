/datum/quirk/helplessness/immobile
	name = "Weak legs"
	desc = "Your legs can't carry the heaviest of weights. At a certain BFI you will become unable to move." + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU IMMOBILE REGARDLESS OF YOUR IMMOBILITY PREFERENCE!")
...
/datum/quirk/helplessness/clumsy
	name = "Clumsy fatass"
	desc = "Weight seems to rob you of your dexterity. " + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU CLUMSY REGARDLESS OF YOUR CLUMSINESS PREFERENCE!")
...
/datum/quirk/helplessness/nearsighted
	name = "Big cheeks"
	desc = "Your cheeks seem to bloat up exceptionally with weight, reducing your visibility. " + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU NEARSIGHTED REGARDLESS OF YOUR NEARSIGHTEDNESS PREFERENCE!")
	icon = "fa-glasses"
	...
	quirk_flags = 0
	erp_quirk = FALSE
	mob_trait = TRAIT_HELPLESS_NEARSIGHTED

/datum/quirk/helplessness/hidden_face
	name = "Hidden face"
	desc = "Your legs can't carry the heaviest of weights. At a certain BFI you will become unable to move. " + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU IMMOBILE REGARDLESS OF YOUR IMMOBILITY PREFERENCE!")
	icon = "fa-weight-hanging"
	medical_record_text = "Patients legs cannot carry heavy weights well."
	...
	mob_trait = TRAIT_HELPLESS_HIDDEN_FACE

/datum/quirk/helplessness/mute
	name = "Many chins"
	desc = "Your chins seem to bloat up exceptionally with weight, making it hard for you to speak. " + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU MUTE REGARDLESS OF YOUR MUTENESS PREFERENCE!")
...
/datum/quirk/helplessness/immobile_arms
	name = "Weak arms"
	desc = "Your arms can't carry the heaviest of weights. At a certain BFI you will become unable to use them." + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOUR ARMS IMMOBILE REGARDLESS OF YOUR ARMS IMMOBILITY PREFERENCE!")
	icon = "fa-dumbbell"
...
/datum/quirk/helplessness/belts
	name = "Wide waist"
	desc = "Any belt you wear seems to give up under the advancing tide of your stomach. Expanding your waistline too much will make you unable to wear belts. " + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU UNABLE TO WEAR BELTS REGARDLESS OF YOUR BELT BREAKING PREFERENCE!")
...
/datum/quirk/helplessness/no_buckle
	...
	desc = "Your exceptional rotundness makes you unable to wear seatbelts. At higher weights you won't be able to be buckled to chairs." + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU UNABLE TO BUCKLE REGARDLESS OF YOUR NO BUCKLING PREFERENCE!")
	icon = "fa-chair"
	medical_record_text = "Patient seems to struggle with wearing seatbelts after big meals."
	value = -1
	gain_text = span_notice("You feel your seatbelt dig into your body uncomfortably")
	lose_text = span_notice("Your seatbelt is no longer uncomfortable")
	quirk_flags = 0
	erp_quirk = FALSE		// this is a lie, however we do it because we want it always on
...
/datum/quirk/helplessness/chair_breakage
	...
	desc = "Chairs tremble when your belly gurgles. At higher weights, attempting to sit on chairs will destroy them." + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU BREAK CHAIRS REGARDLESS OF YOUR CHAIR BREAKAGE PREFERENCE!")
	icon = "fa-couch"
...
/datum/quirk/helplessness/stuckage
	name = "Heavy load"
	desc = "You dread passing through airlocks. At higher weights you will have a chance to get stuck in them." + span_warning("WARNING! PICKING THIS QUIRK WILL MAKE YOU GET STUCK IN AIRLOCKS REGARDLESS OF YOUR STUCKAGE PREFERENCE!")
	icon = "fa-door-closed"
